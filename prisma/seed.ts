...
async function main() {
  ...
  const newFacilities = [
    ...
    { facilityCode: '68', facilityName: 'Jhalokathi Civil Surgeon Office', division: 'Barisal', district: 'Jhalokathi', upazila: 'Jhalokathi', typeSlug: 'district-office', email: 'Jhalokathi@cs.dghs.gov.bd', role: 'USER', password: 'Dghealth@542' },
